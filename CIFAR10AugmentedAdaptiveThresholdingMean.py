...
if __name__ == "__main__":
    ...
    for epoch in range(args.epochs):
        ...
        print(
            "#%d Augmented Adaptive Thresholding Mean Accuracy: %.2f%% Training: %.2fs Testing: %.2fs"
            % (
                epoch + 1,
                result_test,
        ...
        np.savetxt(
            "class_sums/CIFAR10AugmentedAdaptiveThresholdingMean_%d_%d_%d_%.1f_%d_%d_%d.txt"
            % (
                epoch + 1,
                args.num_clauses,
                args.T,
